...
Result AM_GetCiaFileInfo(int a,AM_TitleInfo*i,Handle h){i->titleID=wrong_title?123:0x0004000005a22d00ull;return 0;}
...
int main(int argc,char**argv){
 ...
 assert(Update_ValidVersion(release.version));
